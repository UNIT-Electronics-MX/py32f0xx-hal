...
- [Blinky LED](./examples/blinky.md)
- [Serial Communication](./examples/serial.md)
...
- [USART/Serial](./peripherals/usart.md)
- [ADC](./peripherals/adc.md)
- [SPI](./peripherals/spi.md)
- [I2C](./peripherals/i2c.md)
- [Timers](./peripherals/timers.md)
- [RTC](./peripherals/rtc.md)
- [DMA](./peripherals/dma.md)
...
- [Serial Communication](./troubleshooting/serial.md)
- [GPIO Configuration](./troubleshooting/gpio.md)
- [Debug LED Issues](./troubleshooting/debug-led.md)
- [Build Issues](./troubleshooting/build.md)
- [Verification Guide](./troubleshooting/verification.md)

# Reference

- [Pin Mapping](./reference/pin-mapping.md)
- [Memory Map](./reference/memory-map.md)
- [Clock Tree](./reference/clock-tree.md)
- [Peripheral Support Matrix](./reference/peripheral-matrix.md)

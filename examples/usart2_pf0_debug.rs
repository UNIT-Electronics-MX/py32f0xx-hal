...
fn main() -> ! {
    ...
    // Usar PF0 como LED de debug en lugar de PA0
    let mut led = system.gpiof.pf0.into_push_pull_output();
    led.set_low();
    ...
    // Configuración USART2 SIN CONFLICTOS
    ...
    serial.write_str("=== USART2 con PF0 Debug ===\r\n").ok();
    serial.write_str("PA1: RX (AF9)\r\n").ok();
    serial.write_str("PA2: TX (AF4)\r\n").ok();
    serial.write_str("PF0: Debug LED\r\n").ok();

...
fn main() -> ! {
    ...
    // Usar USART1 (más básico) con PA1=TX, PA2=RX
    // AF1 es la función más básica para USART1
    let tx = system.gpioa.pa1.into_alternate_af1();  // PA1 TX AF1
    let rx = system.gpioa.pa2.into_alternate_af1();  // PA2 RX AF1
